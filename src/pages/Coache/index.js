...
const Coache = () => {
  return (
    <div>
      ...
      <div className="   justify-evenly items-center grid md:grid-cols-2 lg:flex  my-10">
        <div className="flex flex-col items-center justify-center gap-2 my-6">
          <svg
            className="text-4xl text-white bg-[#e4b2d6] hover:bg-red-700 rounded-full py-3 px-3 "
            stroke="currentColor"
            fill="currentColor"
            stroke-width="0"
            viewBox="0 0 640 512"
          ...
          <span className="text-md font-medium text-black font-serif">
            LOREM, IPSUM.
          </span>
          <p className="text-sm font-normal">LOREM IPSUM DOLOR SIT AMET. </p>
        </div>
        <div className="flex flex-col items-center justify-center gap-2 my-6">
          <svg
            className="text-4xl text-white bg-[#dcc698] hover:bg-red-700 rounded-full py-3 px-3"
            stroke="currentColor"
            fill="currentColor"
            stroke-width="0"
            viewBox="0 0 512 512"
        ...
        <div className="flex flex-col items-center justify-center gap-2 my-6">
          <svg
            className="bg-[#a2d1e1] text-4xl text-white  hover:bg-red-700 rounded-full py-3 px-3"
            stroke="currentColor"
            fill="currentColor"
            stroke-width="0"
            viewBox="0 0 512 512"
        ...
        <div className="flex flex-col items-center justify-center gap-2 my-6">
          <svg
            className="bg-[#dcd691] text-4xl text-white hover:bg-red-700 rounded-full py-3 px-3"
            stroke="currentColor"
            fill="currentColor"
            stroke-width="0"
            viewBox="0 0 448 512"
