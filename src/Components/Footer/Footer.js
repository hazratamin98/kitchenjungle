    ...
    <footer className="bg-gray-800  ">
      <div className="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="text-gray-300">
            ...
            <li className="mb-4">
              <a href="nameabout" className="hover:underline"></a>
        ...
        <div>
          ...
          <ul className="text-gray-300">
            <li className="mb-4   flex  items-center gap-2 justify-center">
              <svg
            ...
            <li className="mb-4  flex  items-center gap-14 justify-center ">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                stroke="currentColor"
      ...
      <div className="py-6 px-4 bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-300 sm:text-center">
          © 2022 <a href="https://kitchenjungle.com">KITCHEN JUNGLE</a>. All
          Rights Reserved.
        </span>
